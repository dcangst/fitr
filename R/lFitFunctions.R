...
gcfit	<-	function(data,w_size,od_name,time_name,trafo="logNN0") {
    ...
    fits <- data.frame(minP=filler,nTime=filler,mumax=filler,intercept=filler,pearCoeff=filler,dt=filler,maxOD=max(data$ODtrans,na.rm=TRUE),trafo=trafo, comment=filler)
